...
abstract class DateHelpers {
      ...
      if (match != null) {
        ...
        if (hour < 1 || hour > 12) {
          throw const FormatException(
            'Hour must be between 1 and 12 for AM/PM format',
          );
        }
  ...
  static Future<TimeOfDay?> showDefTimePicker(BuildContext context) async {
    return await showTimePicker(context: context, initialTime: TimeOfDay.now());
  }

  static Future<DateTime?> showDefDatePicker(BuildContext context) async {
  ...
  static DateTime dateTimeReturner(
